...
test('encode throws error for invalid input type', (t) => {
  t.throws(() => encode(123 as any, 'GBK'), { message: 'First argument must be a string' })
})

test('decode throws error for invalid input type', (t) => {
  t.throws(() => decode('not a buffer' as any, 'GBK'), { message: 'First argument must be a Buffer' })
})

test('encode throws error for invalid charset type', (t) => {
  t.throws(() => encode('test', 123 as any), { message: 'Second argument must be a string' })
})

test('decode throws error for invalid charset type', (t) => {
  t.throws(() => decode(Buffer.from('test'), 123 as any), { message: 'Second argument must be a string' })
})
